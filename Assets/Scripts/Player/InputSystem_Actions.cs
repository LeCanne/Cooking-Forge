...
/// </code>
/// </example>
public partial class @Actions_Player: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Drag"",
                    ""type"": ""Value"",
                    ""id"": ""c83189ee-1594-4f97-8631-f26082a2c5f0"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""b520ee77-ad6a-4edb-a72d-fd7edf778333"",
    ...
    ~@Actions_Player()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, Actions_Player.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, Actions_Player.UI.Disable() has not been called.");
    }
    ...
    {
        private @Actions_Player m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@Actions_Player wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@Actions_Player wrapper) { m_Wrapper = wrapper; }
        /// <summary>
